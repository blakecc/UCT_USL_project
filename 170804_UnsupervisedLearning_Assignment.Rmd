...
leuk <- readRDS("output/leuk.rds")

tu_tsne_frame <- readRDS("output/tu_tsne_frame.rds")
tu_model_matrix_scaled_dist_out_classic <- readRDS("output/tu_model_matrix_scaled_dist_out_classic.rds")
tu_model_matrix_scaled_dist_out_sammon <- readRDS("output/tu_model_matrix_scaled_dist_out_sammon.rds")
tu_model_matrix_scaled_dist_out_smacofM <- readRDS("output/tu_model_matrix_scaled_dist_out_smacofM.rds")
tu_model_matrix_scaled_dist_out_smacofNM <- readRDS("output/tu_model_matrix_scaled_dist_out_smacofNM.rds")
tu_model_matrix_scaled_dist_out_Kruskal <- readRDS("output/tu_model_matrix_scaled_dist_out_Kruskal.rds")

leuk_transformed_cols_range01 <- readRDS("output/leuk_transformed_cols_range01.rds")
leuk_transformed_full_range01 <- readRDS("output/leuk_transformed_full_range01.rds")
leuk_transformed_cols_centeredscaled <- readRDS("output/leuk_transformed_cols_centeredscaled.rds")
leuk_transformed_log <- readRDS("output/leuk_transformed_log.rds")
leuk_transformed_log_cols_range01 <- readRDS("output/leuk_transformed_log_cols_range01.rds")
leuk_transformed_log_cols_centeredscaled <- readRDS("output/leuk_transformed_log_cols_centeredscaled.rds")
list_scaled <- readRDS("output/list_scaled.rds")
list_dist <- readRDS("output/list_dist.rds")
list_top100_scaled <- readRDS("output/list_top100_scaled.rds")
list_top100_dist <- readRDS("output/list_top100_dist.rds")

###Q2

tu_cars2 <- readRDS("output/tu_cars2.rds")
tu_model_matrix <- readRDS("output/tu_model_matrix.rds")
...
leuk <- read.table("data/leukemia_array.txt")
leuk <- t(leuk)
...
saveRDS(leuk_transformed_cols_range01, "output/leuk_transformed_cols_range01.rds")
saveRDS(leuk_transformed_full_range01, "output/leuk_transformed_full_range01.rds")
saveRDS(leuk_transformed_cols_centeredscaled, "output/leuk_transformed_cols_centeredscaled.rds")
saveRDS(leuk_transformed_log, "output/leuk_transformed_log.rds")
saveRDS(leuk_transformed_log_cols_range01, "output/leuk_transformed_log_cols_range01.rds")
saveRDS(leuk_transformed_log_cols_centeredscaled, "output/leuk_transformed_log_cols_centeredscaled.rds")
...
saveRDS(list_scaled, "output/list_scaled.rds")
...
saveRDS(leuk_top100_transformed_cols_range01, "output/leuk_top100_transformed_cols_range01.rds")
saveRDS(leuk_top100_transformed_full_range01, "output/leuk_top100_transformed_full_range01.rds")
saveRDS(leuk_top100_transformed_cols_centeredscaled, "output/leuk_top100_transformed_cols_centeredscaled.rds")
saveRDS(leuk_top100_transformed_log, "output/leuk_top100_transformed_log.rds")
saveRDS(leuk_top100_transformed_log_cols_range01, "output/leuk_top100_transformed_log_cols_range01.rds")
saveRDS(leuk_top100_transformed_log_cols_centeredscaled, "output/leuk_top100_transformed_log_cols_centeredscaled.rds")
...
saveRDS(list_top100_scaled, "output/list_top100_scaled.rds")
```
...
saveRDS(list_dist, "output/list_dist.rds")
...
saveRDS(list_top100_dist, "output/list_top100_dist.rds")
...
saveRDS(tu_cars2, "output/tu_cars2.rds")
saveRDS(tu_model_matrix, "output/tu_model_matrix.rds")
...
saveRDS(tu_tsne_frame, "output/tu_tsne_frame.rds")
```
...
saveRDS(tu_model_matrix_scaled_dist_out_classic, "output/tu_model_matrix_scaled_dist_out_classic.rds")
```
...
saveRDS(tu_model_matrix_scaled_dist_out_smacofM, "output/tu_model_matrix_scaled_dist_out_smacofM.rds")
...
saveRDS(tu_model_matrix_scaled_dist_out_smacofNM, "output/tu_model_matrix_scaled_dist_out_smacofNM.rds")
...
saveRDS(tu_model_matrix_scaled_dist_out_Kruskal, "output/tu_model_matrix_scaled_dist_out_Kruskal.rds")
...
saveRDS(tu_model_matrix_scaled_dist_out_sammon, "output/tu_model_matrix_scaled_dist_out_sammon.rds")
